...
function(e) {
    ...
    f.prototype = {
        ...
        setterEventListener: function(e, t, i, r) {
            switch ("keyup" === t && (i = this.bindHandlerKeyup),
            r) {
            case "add":
        ...
        setForm: function(e) {
            ...
            this.$form.addEventListener("submit", function(e) {
                ...
                t.result = [],
                t.getElements(),
                t.promisesRemote.length ? void Promise.all(t.promisesRemote).then(function() {
                    t.promisesRemote = [],
        ...
        getElements: function() {
            ...
            for (var i = function(i, r) {
                var n = t[i]
                  ...
                  , a = !1
                  , l = [];
                if ("checkbox" === n.type && (s = n.checked || "",
                ...
                "radio" === n.type) {
                    ...
                    u ? (u.group.push(n.checked),
                    a = !0) : l.push(n.checked),
                    n.addEventListener("change", function(t) {
                        var i = t.target
                          , r = {
                            name: i.getAttribute("data-validate-field"),
            ...
            if (p)
                for (var g in p) {
                    ...
                    case l:
                        ...
                        return this.setterEventListener(S, "keyup", this.handlerKeyup, "remove"),
